...
export const TEMPLATES: TemplateRow[] = [
  ...
  { id: "11", date: "25/02/25", name: "Cookie Policy", version: "1.0", tags: ["mainaccount", "subaccount"], more: 1, published: true, templateId: "j1k2l…" },
  ...
  { id: "14", date: "14/02/25", name: "Terms of Service Agreement", version: "4.0", tags: ["registration", "tag-test"], more: 2, published: true, templateId: "m1n2o…" },
  { id: "15", date: "10/02/25", name: "Refund Policy", version: "1.0", tags: ["login_only"], published: true, templateId: "n1o2p…" },
  { id: "16", date: "06/02/25", name: "EULA", version: "3.0", tags: ["registration_only", "subaccount"], more: 3, published: false, templateId: "o1p2q…" },
  ...
  { id: "20", date: "20/01/25", name: "Non-Disclosure Agreement", version: "2.0", tags: ["registration", "subaccount"], more: 1, published: true, templateId: "s1t2u…" },
  { id: "21", date: "16/01/25", name: "Terms of Service Agreement", version: "1.0", tags: ["mainaccount", "account_update"], more: 4, published: false, templateId: "t1u2v…" },
  ...
  { id: "25", date: "31/12/24", name: "Data Processing Agreement", version: "3.0", tags: ["account_update", "registration_only"], more: 2, published: true, templateId: "x1y2z…" },
  { id: "26", date: "27/12/24", name: "Terms of Service Agreement", version: "2.0", tags: ["mainaccount", "subaccount"], more: 2, published: true, templateId: "y1z2a…" },
  ...
  { id: "31", date: "06/12/24", name: "Privacy Policy", version: "2.0", tags: ["mainaccount", "registration"], more: 1, published: true, templateId: "d2e3f…" },
  ...
  { id: "34", date: "24/11/24", name: "Terms of Service Agreement", version: "3.0", tags: ["mainaccount", "subaccount"], more: 3, published: true, templateId: "g2h3i…" },
